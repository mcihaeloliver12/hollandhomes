...
$fields = [
    ...
    'metadata' => [
        ...
        'city_tax_label' => (string) ($quote['city_tax_label'] ?? 'City tax'),
        'county_tax_rate' => number_format((float) $quote['county_tax_rate'], 2, '.', ''),
        'county_tax_amount' => number_format((float) $quote['county_tax_amount'], 2, '.', ''),
        'county_tax_label' => (string) ($quote['county_tax_label'] ?? 'County tax'),
